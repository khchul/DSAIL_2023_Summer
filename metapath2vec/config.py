...
def config_parser():
    ...
    parser.add_argument('--N_walk', type=int, default=200, help='Number of walks per node')
    ...
    #Metapath2vec
    parser.add_argument('--is_meta', action='store_true', help='Is metapath')
    parser.add_argument('--metapath', type=str, help='Given metapath')

    #Deepwalk & node2vec
    parser.add_argument('--p', type=int, default=1, help='Probability p')
    parser.add_argument('--q', type=int, default=1, help='Probability q')
